...
function main() {
  const { config, minutes, percentFiring, trafficGenerator, trafficGeneratorId, command, commandArgs } = parseArgs()
  ...
  try {
    commandHandler({ config, minutes, percentFiring, trafficGenerator, trafficGeneratorId }, commandArgs)
  } catch (err) {
