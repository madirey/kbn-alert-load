...
function main() {
  const { config, minutes, percentFiring, trafficGenerator, command, commandArgs } = parseArgs()
  ...
  try {
    commandHandler({ config, minutes, percentFiring, trafficGenerator }, commandArgs)
  } catch (err) {
