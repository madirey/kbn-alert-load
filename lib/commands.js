...
/** @type { CommandHandler } */
async function run({ config, minutes, percentFiring, esUrl, kbUrl, scenario, trafficGenerator, trafficGeneratorId, reportFileName }, [ suiteId ]) {
  if (suiteId == null) {
  ...
  generateReport(runName, suite, deployments, completeLog, kbStatusList, esStatusList, kbTaskManagerStatusList, ruleStatus, reportFileName)
