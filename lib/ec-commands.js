...
async function createDeployment({ config, stack, name, deploymentName, esSize, kbSize, tmMaxWorkers, tmPollInterval, topologyType }) {
...
function updatePlan(payload, esSize, kbSize) {
  ...
  payload.resources.elasticsearch[0].plan.deployment_template = {id: "gcp-io-optimized"}
