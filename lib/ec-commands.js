...
async function createDeployment({ config, stack, name, deploymentName, esSize, kbSize, tmMaxWorkers, tmPollInterval }) {
  ...
  // deploy a cluster in hot-warm-cold architecture TODO: add flag
  // payload.resources.elasticsearch[0].plan.deployment_template = {
  //   "id": "aws-io-optimized-v2"
  // }
  payload.resources.elasticsearch[0].plan.cluster_topology = [
    {
      "elasticsearch": {
  ...
  // const tmpFile = "/Users/jchu/deploymentconfig.json"
