...
function queryRule(ruleName, value="ALERT", enabled=true, alertInterval='6m') {
    return {
        "type": "query",
        "index": [
            "test-*"
...
function indicatorRule(ruleName, field, entriesCount=1, enabled=true, alertInterval='6m') {
...
function thresholdRule(ruleName, thresholdField= "num_value", thresholdValue=10, enabled=true, alertInterval='1m') {
    return {
        "type": "threshold",
        "index": [
            "test-*"
