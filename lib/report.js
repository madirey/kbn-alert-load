...
function generateReport(runName, suite, deployments, eventLog, eventCounts, kbStatus, esStatus, kbTaskManagerStatusList, ruleStatus, reportFileName, outputFolder) {
  ...
  const content = readTemplate(reportFileName)
    ...
    .replace('["%EventCounts%"]', JSON.stringify(eventCounts))
